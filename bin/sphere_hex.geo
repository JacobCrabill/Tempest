...
size1 = .3;  // .19
size2 = .7;  // .55
R1 = .5;  // Radius of inner sphere
R2 = 8;  // Radius of outer sphere
NN = 7;  // Number of points in each direction on each spherical surface
NL = 17;  // Number of layers between surfaces
...
Transfinite Line {1:12} = NN Using Progression 1.0;
...
Point(12) = {-R2, -R2, -R2, size1};
Point(13) = { R2, -R2, -R2, size1};
Point(14) = { R2,  R2, -R2, size1};
Point(15) = {-R2,  R2, -R2, size1};

Point(16) = {-R2, -R2, R2, size1};
Point(17) = { R2, -R2, R2, size1};
Point(18) = { R2,  R2, R2, size1};
Point(19) = {-R2,  R2, R2, size1};
...
Transfinite Line {21:32} = NN Using Progression 1.0;
...
Transfinite Line {41:48} = NL Using Progression prog1;
